...
export default function Testimonials() {
    const slides = [
        {
            name: "Sarah Khan • Palm Jumeirah",
            review: "The team was reliable and efficient. Our villa garden now feels like a private retreat.",
            star: 5,
        },
        {
            name: "Ahmed Rashid •  Sharjah Residence",
            review: "From design to finishing, everything was handled smoothly. Truly professional service.",
            star: 5,
        },
        {
            name: "Al Fardan • Dubai Hills Villa",
            review: "Unique Garden Tech transformed our backyard beautifully. The work was high-quality and on time.",
            star: 5,
        },
        {
            name: "Ahmed Rashid •  Sharjah Residence",
    ...
    return (
        <section className="widget-wrapper bg testimonials" id="testimonials">
            ...
            <div className="widget-wrapper review-cards">
                <Swiper
                                ...
                                <div className="text-content-wrapper">
                                    ...
                                    <span className="star">
                                        ...
                                        {Array.from({ length: Number(item.star) }).map((_, index) => (
                                            <svg key={index} xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                                <path
